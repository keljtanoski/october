...
return [
    'cms_object' => [
        'invalid_file' => 'Невалидно име на датотека: :name. Имињата на датотеките можат да содржат само алфанумерички симболи, долни црти, тире и точки. Неколку примери за точни имиња на датотеки: page.htm, page, subdirectory/page',
        'invalid_property' => "Не може да се постави својството ':name'",
        'file_already_exists' => "Веќе постои датотека со име ':name'.",
        'error_saving' => "Грешка при зачувување на датотеката ':name'. Проверете ги пермисиите за запишување.",
        'error_creating_directory' => 'Грешка при креирање директориум :name. Проверете ги пермисиите за запишување.',
        'invalid_file_extension' => 'Невалидна наставка на датотека: :invalid. Дозволени наставки се: :allowed.',
        'error_deleting' => "Грешка при бришење на темплјет датотеката ':name'. Проверете ги дозволите за запишување.",
        'delete_success' => 'Избришени темплјети: :count.',
        'file_name_required' => 'Полето за внес на име на датотеката е задолжително.',
    ...
    'dashboard' => [
        'active_theme' => [
            'widget_title_default' => 'Веб-страница',
            'online' => 'онлајн',
            'maintenance' => 'Во одржување',
            'manage_themes' => 'Управување со теми',
            'customize_theme' => 'Персонализација на тема',
        ],
    ],
    'theme' => [
        'not_found_name' => "Темата ':name' не е пронајдена.",
        'by_author' => 'Од :name',
        'active' => [
            'not_set' => 'Активната тема не е поставена.',
            'not_found' => 'Активната тема не е пронајдена.',
        ],
        'edit' => [
            'not_set' => 'Темата за уредување не е поставена.',
            'not_found' => 'Темата за уредување не е пронајдена.',
            'not_match' => "Објектот до кој се обидувате да пристапите не припаѓа на темата што се уредува. Ве молиме, повторно вчитајте ја страницата.",
        ],
        'settings_menu' => 'Тема на предната страна',
        'settings_menu_description' => 'Manage the front-end theme and customization options.',
        'default_tab' => 'Својства',
        'name_label' => 'Име',
        'name_create_placeholder' => 'Име на новата тема',
        'author_label' => 'Автор',
        'author_placeholder' => 'Person or company name',
        'description_label' => 'Опис',
        'description_placeholder' => 'Опис на темата',
        'homepage_label' => 'Главна страница',
