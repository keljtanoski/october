...
return [
    'auth' => [
        ...
        'invalid_login' => 'Информациите што ги внесовте не се совпаѓаат со нашите податоци, Ве молиме проверете и обидете се повторно.',
    ],
    'field' => [
        'invalid_type' => 'Користен невалиден тип на поле :type.',
    ...
    'page' => [
        'untitled' => 'Без наслов',
        '404' => [
            'label' => 'Страната не е пронајдена',
            'help' => "Баравме и пребарувавме, но бараната URL-адреса едноставно не можеше да се најде. Можеби баравте нешто друго?",
            'back_link' => 'Вратете се на претходната страница',
        ],
        'access_denied' => [
            'label' => 'Одбиен пристап',
            'help' => "Немате дозвола да ја видите оваа страница",
            'cms_link' => 'Вратете се на back-end',
        ],
        'no_database' => [
            'label' => 'Недостасува база на податоци',
            'help' => "A database is required to access the back-end. Check the database is configured and migrated before trying again.",
            'cms_link' => 'Вратете се на почетната страница',
        ],
    ],
    'partial' => [
